...
export const WorkspaceList = () => {
  ...
  return (
    <section id="workspace-list" className="workspace-list">
      ...
      <div
        id="workspace-icon-id"
        className="workspace-icon"
        onClick={() => {
          setIsShowNewWorkspaceModal(true)
        }}
      >
        ...
        >
          ...
          <div className="input-block">
            ...
            <input
              type="text"
              className="text-box"
              value={workspaceInfoState.dirName}
              onChange={inputDirNameOnChange}
            ></input>
          </div>
          <div className="input-block">
          ...
          <div className="form-buttons">
            ...
            <button type="submit" className="button" onClick={createNewWorkspace}>
              作成
            </button>
          </div>
          <div className="existing-workspace-link" onClick={showAddWorkspaceModal}>
            既存のワークスペースを追加する場合はこちら
          </div>
        </form>
      </ReactModal>
      ...
      <ReactModal
        ...
        onRequestClose={() => {
          setIsShowAddWorkspaceModal(false)
        }}
        style={reactModalStyle}
      >
        <form
        ...
        >
          ...
          <div className="form-buttons">
            ...
            <button type="submit" className="button" onClick={AddExistingWorkspace}>
              追加
            </button>
          </div>
        </form>
      ...
      <ReactModal
        ...
        onRequestClose={() => {
          setIsShowDeleteWorkspaceModal(false)
        }}
        style={reactModalStyle}
      >
        <form
        ...
        >
          ...
          <div className="content">※uzumeからは削除されますが、ワークスペースフォルダは削除されません。</div>
          <div className="show-block">
          ...
          <div className="form-buttons">
            ...
            <button
              ...
              className="button"
              onClick={() => {
                deleteWorkspace(deleteWorkspaceState.workspaceId)
              }}
            >
              削除
            </button>
      ...
      <ReactModal
        ...
        onRequestClose={() => {
          setIsShowSetIconModalState(false)
        }}
        style={reactModalStyle}
      >
        <form
        ...
        >
          ...
          <div className="show-block">
            ...
            <button type="button" className="button" onClick={selectWorkspaceIcon}>
              画像選択
            </button>
          </div>
          <div className="form-buttons">
            ...
            <button
              ...
              className="button"
              onClick={() => {
                setWorkspaceIcon(workspaceIconState.workspaceId)
              }}
            >
              設定
            </button>
      ...
      <ReactModal
        ...
        onRequestClose={() => {
          setIsShowUpdateWorkspaceNameModalState(false)
        }}
        style={reactModalStyle}
      >
        <form
        ...
        >
          ...
          <div className="show-block">
            ...
            <input
              type="text"
              className="text-box"
              value={updateWorkspaceNameState.name}
              onChange={updateWorkspaceNameOnChange}
            ></input>
          </div>
          <div className="form-buttons">
            <button
            ...
            <button type="submit" className="button" onClick={updateWorkspaceName}>
              変更
            </button>
          </div>
        </form>
